...
| [ADR-010](./ADR-010-Product-Focus-Climate-Yield-Intelligence.md) | Product focus: climate & yield intelligence first | Accepted (amended by ADR-012 for role sidebars) |
| [ADR-011](./ADR-011-Maize-Yield-ML-Spike.md) | Experimental maize yield ML spike (Stage A) | Accepted (experimental) |
| [ADR-012](./ADR-012-Owner-Role-Sidebars.md) | Owner role sidebars & scoped partner surfaces | Accepted |
