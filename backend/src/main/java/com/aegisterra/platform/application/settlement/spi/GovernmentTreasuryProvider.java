...
@Component
public class GovernmentTreasuryProvider implements PaymentProvider {

    public static final String CODE = "GOVERNMENT_TREASURY";
    ...
    public boolean supports(String paymentMethod) {
        return "TREASURY".equalsIgnoreCase(paymentMethod) || CODE.equalsIgnoreCase(paymentMethod);
    }
