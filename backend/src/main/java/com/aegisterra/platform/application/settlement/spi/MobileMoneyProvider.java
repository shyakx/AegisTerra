...
@Component
public class MobileMoneyProvider implements PaymentProvider {

    public static final String CODE = "MOBILE_MONEY";
    ...
    public boolean supports(String paymentMethod) {
        return "MOBILE_MONEY".equalsIgnoreCase(paymentMethod) || "MOMO".equalsIgnoreCase(paymentMethod);
    }
